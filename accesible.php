    ...
    <body>
        ...
        <main id="salta" aria-label="Contenido principal">
            ...
            <section class="primero">
                ...
                <video id="v-background" playsinline autoplay muted loop aria-hidden="true" aria-label='Video en el que se ve a una mantis limpiandose las patas en bucle'>
...
if ($ordenes === false) {
    ...
    ?>
                    ...
                    <article  aria-labelledby="titulo-orden" aria-describedby="descripcion-orden"> 
                        ...
                        <a class="bajar" href="#informacion_contacto" tabindex='6' aria-controls="informacion_contacto"          
                           aria-label="Saltar al footer">Saltar al pie de página</a>
